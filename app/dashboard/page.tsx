...
export default function Dashboard() {
  ...
  const [passiveQuests, setPassiveQuests] = useState<any[]>([
    { id: 1, name: 'High-Interest Savings', category: 'beginner', icon: '🏦', description: 'Put your savings to work earning interest over time', potentialIncome: '$5-20/mo', difficulty: 'Easy', timeToSetup: '15 mins', status: 'not_started', progress: 0, currentStep: 0, monthlyIncome: 0, steps: [{ title: 'Research accounts', description: 'Use ASIC Moneysmart to compare savings accounts yourself (moneysmart.gov.au). Look at: interest rate, any conditions (minimum deposits, restrictions on withdrawals), and fees. Aureus cannot recommend specific accounts.', action: "I'll research savings accounts" }, { title: 'Open account', description: 'Most can be opened online in 10 minutes with just your ID', action: "I've opened my account" }, { title: 'Set up auto-transfer', description: 'Transfer your emergency fund or set up regular deposits', action: 'Money is transferred' }, { title: 'Track your interest', description: 'Watch passive income grow! $10k at 5% = $42/mo', action: 'Complete quest' }], aureusAdvice: 'Interest compounds over time — money earns interest on its interest. Use the ASIC Moneysmart savings calculator at moneysmart.gov.au to see how your balance could grow. Aureus cannot recommend specific accounts — that requires a financial services licence.' },
    { id: 2, name: 'Cashback & Rewards', category: 'beginner', icon: '💳', description: 'Earn cashback on spending you already do', potentialIncome: '$10-50/mo', difficulty: 'Easy', timeToSetup: '20 mins', status: 'not_started', progress: 0, currentStep: 0, monthlyIncome: 0, steps: [{ title: 'Research cards', description: 'Aureus cannot recommend specific credit cards — that requires a Credit Licence. Compare cashback and rewards cards yourself using ASIC Moneysmart at moneysmart.gov.au/credit-cards. Check: annual fee, cashback rate, interest rate, and conditions.', action: "I've researched options" }, { title: 'Apply for card', description: 'Read the product disclosure statement before applying. Approval typically takes 1-5 business days. Only apply for one card at a time — multiple applications affect your credit score.', action: 'Card approved' }, { title: 'Set as default', description: 'Use for all regular spending - groceries, bills, fuel', action: 'Using the card' }, { title: 'Redeem rewards', description: 'Cash out monthly or let points accumulate for bigger rewards', action: 'Complete quest' }], aureusAdvice: 'The golden rule: only use a rewards card if you pay it off in full every month. Interest charges at 18-20%+ will wipe out any cashback earned. Aureus cannot recommend which card — compare options yourself at moneysmart.gov.au/credit-cards.' },
    { id: 4, name: 'Dividend ETFs', category: 'intermediate', icon: '📈', description: 'Earn quarterly dividends from Aussie shares', potentialIncome: 'Varies — depends on amount invested and market conditions', difficulty: 'Medium', timeToSetup: '1 hour', status: 'not_started', progress: 0, currentStep: 0, monthlyIncome: 0, steps: [{ title: 'Open brokerage', description: 'Aureus cannot recommend specific brokers — that requires a financial services licence. Research brokerage platforms yourself using ASIC Moneysmart at moneysmart.gov.au/shares. Check: brokerage fee per trade, account minimums, and ASIC regulation.', action: 'Brokerage opened' }, { title: 'Research ETFs', description: 'Aureus cannot recommend specific ETFs or predict their returns — that requires an Australian Financial Services Licence. Research ETFs yourself using ASIC Moneysmart (moneysmart.gov.au/shares/exchange-traded-funds-etfs) and each fund\'s Product Disclosure Statement (PDS).', action: 'Picked my ETF' }, { title: 'Make first investment', description: 'Start with $500+. More = more dividends. Consider DRP (reinvest)', action: 'First purchase done' }, { title: 'Set up regular buys', description: 'Automate monthly purchases. Time in market beats timing market', action: 'Complete quest' }], aureusAdvice: 'ETFs (Exchange Traded Funds) let you own a small piece of many companies at once, spreading risk. But Aureus cannot recommend which ETF to buy, how much to invest, or what returns to expect — a licensed financial adviser can assess whether this suits your situation. Learn the basics first at moneysmart.gov.au/shares/exchange-traded-funds-etfs.' },
...
Rules: Be specific. No generic advice. Keep responses concise unless detail is requested.`
  ...
  const literacyTopics = [
    ...
    },
    {
      ...
      content: `Negative gearing is when an investment property costs more to hold than it earns in rent, resulting in a net loss each year.\n\nAureus cannot give tax advice — the tax treatment of investment properties (including negative gearing deductions) depends on your specific situation and requires a registered tax agent.\n\nFor accurate information on negative gearing and investment property tax:\n• ATO investment property guide: ato.gov.au/individuals-and-families/investments-and-assets/rental-properties\n• Find a registered tax agent: tpb.gov.au/find-tax-agent-bas-agent-or-payroll-service-provider\n• ASIC Moneysmart investment properties: moneysmart.gov.au/property-investment\n\nWhat Aureus CAN help with:\n• Tracking your rental income and expenses\n• Calculating your mortgage and cashflow numbers\n• Showing how property fits into your overall wealth picture`,
