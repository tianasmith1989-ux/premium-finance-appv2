      ...
      <div style={{ minHeight: '100vh', background: darkMode ? 'linear-gradient(135deg, #0f172a 0%, #1e1b4b 100%)' : 'linear-gradient(135deg, #f0f9ff 0%, #faf5ff 100%)', display: 'flex', flexDirection: 'column' as const, alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
        ...
        {totalPL !== 0 && (
          <div style={{ marginTop: '32px', padding: '16px 24px', background: theme.cardBg, borderRadius: '16px', border: '1px solid ' + theme.border }}>
            <p style={{ color: theme.textMuted, margin: 0, fontSize: '14px' }}>💡 Your trading profits (${totalPL.toFixed(0)}) automatically flow into Budget Mode income</p>
          </div>
        )}
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <thead>
                  <tr style={{ borderBottom: '2px solid ' + theme.border }}>
                    <th style={{ padding: '8px', textAlign: 'left' as const, color: theme.textMuted, fontSize: '12px' }}>✓</th>
                    <th style={{ padding: '8px', textAlign: 'left' as const, color: theme.textMuted, fontSize: '12px' }}>Date</th>
                    <th style={{ padding: '8px', textAlign: 'left' as const, color: theme.textMuted, fontSize: '12px' }}>Description</th>
                    <th style={{ padding: '8px', textAlign: 'left' as const, color: theme.textMuted, fontSize: '12px' }}>Amount</th>
                    <th style={{ padding: '8px', textAlign: 'left' as const, color: theme.textMuted, fontSize: '12px' }}>Category</th>
                    <th style={{ padding: '8px', textAlign: 'left' as const, color: theme.textMuted, fontSize: '12px' }}>Type</th>
                  </tr>
                </thead>
                <tbody>
        ...
        {activeTab === 'dashboard' && (
          <div style={{ display: 'flex', flexDirection: 'column' as const, gap: '24px' }}>
                    ...
                    {(() => {
                      ...
                      return (
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px' }}>
                          <div style={{ padding: '12px', background: darkMode ? '#334155' : '#fff', borderRadius: '8px', textAlign: 'center' as const }}>
                          ...
                          {totalExtras > 0 && <div style={{ gridColumn: '1 / -1', padding: '12px', background: theme.purple + '20', borderRadius: '8px', textAlign: 'center' as const }}><div style={{ color: theme.purple, fontSize: '14px', fontWeight: 600 }}>⚡ Total extra payments: ${totalExtras.toFixed(0)}/month</div></div>}
                        </div>
                      )
                    })()}
                  </div>
            ...
            <div style={cardStyle}>
              ...
              <div style={{ display: 'flex', gap: '8px', marginBottom: '16px', flexWrap: 'wrap' as const, padding: '16px', background: darkMode ? '#334155' : '#f8fafc', borderRadius: '12px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column' as const, gap: '12px' }}>
                {goals.length === 0 ? <div style={{ color: theme.textMuted, textAlign: 'center' as const, padding: '20px' }}>No goals added</div> : goals.map(goal => {
          ...
          <div style={{ display: 'flex', flexDirection: 'column' as const, gap: '24px' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
              <div style={cardStyle}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column' as const, gap: '10px', maxHeight: '200px', overflowY: 'auto' as const }}>
            ...
            <div style={cardStyle}>
              ...
              <div style={{ maxHeight: '250px', overflowY: 'auto' as const, marginBottom: '16px', padding: '16px', background: darkMode ? '#0f172a' : '#f8fafc', borderRadius: '12px' }}>
                {chatMessages.length === 0 ? <div style={{ color: theme.textMuted, textAlign: 'center' as const, padding: '30px' }}>💬 Ask me anything!</div> : chatMessages.map((msg, idx) => (<div key={idx} style={{ marginBottom: '12px', padding: '12px', background: msg.role === 'user' ? theme.accent : (darkMode ? '#334155' : 'white'), color: msg.role === 'user' ? 'white' : theme.text, borderRadius: '10px', marginLeft: msg.role === 'user' ? '20%' : '0', marginRight: msg.role === 'user' ? '0' : '20%' }}><div style={{ fontSize: '11px', marginBottom: '4px', opacity: 0.7 }}>{msg.role === 'user' ? '👤 You' : '🤖 Coach'}</div><div style={{ whiteSpace: 'pre-wrap' }}>{msg.content}</div></div>))}
              </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' as const, gap: '24px' }}>
            <div style={cardStyle}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px' }}>
                ...
                <div style={{ padding: '20px', background: darkMode ? '#334155' : '#f8fafc', borderRadius: '12px', textAlign: 'center' as const }}><div style={{ color: theme.textMuted, fontSize: '13px', marginBottom: '8px' }}>💳 Debt</div><div style={{ color: theme.danger, fontSize: '28px', fontWeight: 'bold' }}>${totalDebtBalance.toFixed(0)}</div></div>
                <div style={{ padding: '20px', background: darkMode ? '#334155' : '#f8fafc', borderRadius: '12px', textAlign: 'center' as const }}><div style={{ color: theme.textMuted, fontSize: '13px', marginBottom: '8px' }}>🌴 Passive</div><div style={{ color: theme.success, fontSize: '28px', fontWeight: 'bold' }}>${passiveIncome.toFixed(0)}/mo</div></div>
              </div>
            </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' as const, gap: '24px' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column' as const, gap: '10px' }}>
                    ...
                    {forexProp.phase === 'funded' && (
                      <>
                        ...
                        <div style={{ padding: '12px', background: theme.success + '20', borderRadius: '8px', textAlign: 'center' as const }}>
              ...
              {forexPropResults && (
                <div>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '12px', marginBottom: '20px' }}>
                    <div style={{ padding: '16px', background: forexPropResults.profitProgress >= 100 ? (darkMode ? '#1e3a32' : '#f0fdf4') : (darkMode ? '#1e293b' : '#f8fafc'), borderRadius: '10px', textAlign: 'center' as const, border: forexPropResults.profitProgress >= 100 ? '2px solid ' + theme.success : '1px solid ' + theme.border }}>
                    ...
                    <div style={{ padding: '16px', background: darkMode ? '#3a1e1e' : '#fef2f2', borderRadius: '10px', textAlign: 'center' as const }}>
                    ...
                    <div style={{ padding: '16px', background: darkMode ? '#1e293b' : '#f8fafc', borderRadius: '10px', textAlign: 'center' as const }}>
                    ...
                    <div style={{ padding: '16px', background: darkMode ? '#2d1e3a' : '#faf5ff', borderRadius: '10px', textAlign: 'center' as const }}>
            ...
            <div style={cardStyle}>
              ...
              {futuresPropResults && (
                <div>
                  {/* Status Cards */}
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '12px', marginBottom: '20px' }}>
                    <div style={{ padding: '16px', background: futuresPropResults.profitProgress >= 100 ? (darkMode ? '#1e3a32' : '#f0fdf4') : (darkMode ? '#1e293b' : '#f8fafc'), borderRadius: '10px', textAlign: 'center' as const, border: futuresPropResults.profitProgress >= 100 ? '2px solid ' + theme.success : '1px solid ' + theme.border }}>
                      <div style={{ color: theme.textMuted, fontSize: '11px', marginBottom: '6px' }}>Profit Progress</div>
                    ...
                    <div style={{ padding: '16px', background: futuresPropResults.lockedAtBreakeven ? (darkMode ? '#1e3a32' : '#f0fdf4') : (darkMode ? '#3a1e1e' : '#fef2f2'), borderRadius: '10px', textAlign: 'center' as const, border: futuresPropResults.lockedAtBreakeven ? '2px solid ' + theme.success : '1px solid ' + theme.border }}>
                  ...
                  <div style={{ padding: '16px', background: darkMode ? '#3a2e1e' : '#fffbeb', borderRadius: '10px', marginBottom: '20px' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '12px', textAlign: 'center' as const }}>
                      <div>
                    ...
                    <div style={{ marginTop: '12px', padding: '8px', background: darkMode ? '#1e293b' : '#fff', borderRadius: '6px' }}>
                      ...
                      <div style={{ width: '100%', height: '16px', background: theme.danger + '30', borderRadius: '8px', position: 'relative' as const, overflow: 'hidden' }}>
                        <div style={{ position: 'absolute' as const, left: 0, top: 0, width: ((futuresPropResults.currentBalance - futuresPropResults.drawdownThreshold) / (futuresPropResults.accountSize + futuresPropResults.profitTarget - futuresPropResults.drawdownThreshold)) * 100 + '%', height: '100%', background: 'linear-gradient(to right, ' + theme.warning + ', ' + theme.success + ')', borderRadius: '8px' }} />
                      </div>
                    </div>
                  </div>
                    ...
                    <div>
                      ...
                      <div style={{ display: 'flex', gap: '8px' }}>
                        <div style={{ flex: 1 }}>
                          ...
                          <div style={{ fontSize: '10px', color: theme.textMuted, textAlign: 'center' as const }}>Years</div>
                        </div>
                        <div style={{ flex: 1 }}>
                          ...
                          <div style={{ fontSize: '10px', color: theme.textMuted, textAlign: 'center' as const }}>Months</div>
                        </div>
                        <div style={{ flex: 1 }}>
                          ...
                          <div style={{ fontSize: '10px', color: theme.textMuted, textAlign: 'center' as const }}>Days</div>
                        </div>
                      </div>
                    </div>
                    <div>
              ...
              {tradingResults && (
                <div>
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px', marginBottom: '24px' }}>
                    ...
                    <div style={{ padding: '20px', background: darkMode ? '#1e293b' : '#f8fafc', borderRadius: '12px', textAlign: 'center' as const }}>
                    ...
                    <div style={{ padding: '20px', background: darkMode ? '#3a2e1e' : '#fffbeb', borderRadius: '12px', textAlign: 'center' as const }}>
                      ...
                      <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                        <thead>
                          <tr style={{ borderBottom: '1px solid ' + theme.border }}>
                            <th style={{ textAlign: 'left' as const, padding: '8px', color: theme.textMuted, fontSize: '11px', fontWeight: 600 }}>Year</th>
                            <th style={{ textAlign: 'left' as const, padding: '8px', color: theme.textMuted, fontSize: '11px', fontWeight: 600 }}>Portfolio Value</th>
                            <th style={{ textAlign: 'left' as const, padding: '8px', color: theme.textMuted, fontSize: '11px', fontWeight: 600 }}>Total Contributed</th>
                            <th style={{ textAlign: 'left' as const, padding: '8px', color: theme.textMuted, fontSize: '11px', fontWeight: 600 }}>Profit</th>
                          </tr>
                        </thead>
                        <tbody>
                ...
                <>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: '6px' }}>
                    {['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'].map(day => (
                      <div key={day} style={{ textAlign: 'center' as const, fontWeight: 600, color: theme.textMuted, padding: '10px', fontSize: '13px' }}>{day}</div>
                    ))}
                    ...
                    {Array.from({ length: new Date(tradingCalendarMonth.getFullYear(), tradingCalendarMonth.getMonth() + 1, 0).getDate() }).map((_, i) => {
                      ...
                      return (
                        <div key={day} style={{ 
                          ...
                          {isTradingDay && (
                            <div style={{ fontSize: '11px', padding: '4px', background: darkMode ? '#3a2e1e' : '#fffbeb', borderRadius: '4px', color: theme.warning, textAlign: 'center' as const }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
              <div style={cardStyle}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                  <div style={{ padding: '20px', background: darkMode ? '#334155' : '#f8fafc', borderRadius: '12px', textAlign: 'center' as const }}>
            ...
            <div style={cardStyle}>
              ...
              <div style={{ overflowX: 'auto' as const }}>
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                  <thead>
                    <tr style={{ borderBottom: '2px solid ' + theme.border }}>
                      <th style={{ textAlign: 'left' as const, padding: '12px', color: theme.textMuted, fontSize: '12px', fontWeight: 600 }}>Date</th>
                      <th style={{ textAlign: 'left' as const, padding: '12px', color: theme.textMuted, fontSize: '12px', fontWeight: 600 }}>Instrument</th>
                      <th style={{ textAlign: 'left' as const, padding: '12px', color: theme.textMuted, fontSize: '12px', fontWeight: 600 }}>Direction</th>
                      <th style={{ textAlign: 'left' as const, padding: '12px', color: theme.textMuted, fontSize: '12px', fontWeight: 600 }}>Entry</th>
                      <th style={{ textAlign: 'left' as const, padding: '12px', color: theme.textMuted, fontSize: '12px', fontWeight: 600 }}>Exit</th>
                      <th style={{ textAlign: 'left' as const, padding: '12px', color: theme.textMuted, fontSize: '12px', fontWeight: 600 }}>P&L</th>
                      <th style={{ textAlign: 'left' as const, padding: '12px', color: theme.textMuted, fontSize: '12px', fontWeight: 600 }}>Notes</th>
                    </tr>
                  </thead>
                  <tbody>
                    {trades.length === 0 ? (
                      <tr><td colSpan={7} style={{ textAlign: 'center' as const, padding: '40px', color: theme.textMuted }}>No trades recorded yet</td></tr>
                    ) : (
                      trades.map(trade => (
